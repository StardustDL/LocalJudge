...
namespace StarOJ.Server.Host.APIClients
{
    ...
    public partial class AdminClient : StarOJ.Server.Host.APIClients.BaseClient
    {
    ...
    public partial class ProblemsClient : StarOJ.Server.Host.APIClients.BaseClient
    {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<ProblemMetadata> CreateAsync()
        {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<ProblemMetadata> CreateAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/Problems");
