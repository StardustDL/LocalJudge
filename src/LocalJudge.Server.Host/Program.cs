...
namespace LocalJudge.Server.Host
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                Description = "Server Host for LocalJudge"
            };

            rootCommand.AddOption(new Option(new string[] { "--api-server", "-s" }, "The server of LocalJudge API.", new Argument<string>("https://localhost:5001")));
